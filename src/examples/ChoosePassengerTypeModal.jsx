...
export default function ChoosePassengerTypeModal() {
    const passengerType = [
        {
            id: 1,
            category: 'Dewasa',
                    ...
                    <div className='flex flex-col gap-2 px-5'>
                        {passengerType &&
                            passengerType.map((passenger) => (
                                <div key={passenger.id} className='flex items-center  justify-between border-b-[1px] border-b-net-2 py-2 font-normal'>
                                    <div className='flex items-start gap-3 '>
                                        ...
                                        <div className='p-0'>
                                            ...
                                            <p className='font-poppins text-body-6 font-normal text-net-3'>{passenger.description}</p>
                                        </div>
                                    </div>
